...
function CreatePasswordPage() {
  ...
  return (
    <div className="fixed inset-0 w-[99.5%]  left-1/2 -translate-x-1/2  bg-white z-50 rounded-2xl overflow-hidden">
      <div className="w-screen h-screen bg-[linear-gradient(360deg,#F79F00,#effffd,#51C3B7) blur-[197px] reletive  flex flex-col items-center justify-end pb-1 opacity-70 ">
